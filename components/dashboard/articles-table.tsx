        ...
        {loading ? (
          ...
          <div className="overflow-auto">
            <Table>
              <TableHeader>
                <TableRow>
                  <TableHead onClick={() => toggleSort('title')} className="cursor-pointer hover:bg-muted/60 w-[40%]">
                    <div className="flex items-center">
                      Title
                      {getSortIcon('title')}
                    </div>
                  </TableHead>
                  <TableHead onClick={() => toggleSort('source')} className="cursor-pointer hover:bg-muted/60 hidden sm:table-cell">
                    <div className="flex items-center">
                      Source
                      {getSortIcon('source')}
                    </div>
                  </TableHead>
                  <TableHead onClick={() => toggleSort('date')} className="cursor-pointer hover:bg-muted/60 w-[25%]">
                    <div className="flex items-center">
                      Date
                      {getSortIcon('date')}
                    </div>
                  </TableHead>
                  <TableHead onClick={() => toggleSort('sentiment')} className="cursor-pointer hover:bg-muted/60 w-[25%]">
                    <div className="flex items-center">
                      Sentiment
